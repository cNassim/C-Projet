...
public:  
	...
	/* Nécessite : Rien  
	/* Sortie : Rien  
	/* Entraîne : Affiche les informations de l'arc, y compris  
	/*            les sommets de départ et d'arrivée  
	/***********************************************************/  
	void ARCAfficher();  
	...
	/***********************************************************/  
	static CArc<T> ARCInverserArc(CArc<T>& arc);

	/***********************************************************  
	/* operator==  
	/***********************************************************  
	/* Entrée : Référence à un autre objet CArc  
	/* Nécessite : L'objet CArc doit être valide  
	/* Sortie : Booléen indiquant si les deux arcs sont égaux  
	/* Entraîne : Compare les sommets de départ et d'arrivée  
	/***********************************************************/  
